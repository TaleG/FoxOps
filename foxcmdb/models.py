...
class Asset(models.Model):
    ...
    admin = models.CharField(u'管理员',null=True,blank=True,max_length=64)
...
class Tag(models.Model):
    ...
    creater = models.CharField(u'用户',blank=True,null=True,max_length=64)

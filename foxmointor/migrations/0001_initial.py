# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-11-18 01:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host_groups', models.ManyToManyField(blank=True, to='foxmointor.HostGroup')),
                ('hosts', models.ManyToManyField(blank=True, to='foxmointor.Host')),
            ],
        ),
        migrations.CreateModel(
            name='Service',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('services', models.ManyToManyField(to='foxmointor.Service', verbose_name='\u670d\u52a1\u5217\u8868')),
            ],
        ),
        migrations.CreateModel(
            name='Trigger',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='foxmointor.Service', verbose_name='\u5173\u8054\u670d\u52a1')),
                ('service_index', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='foxmointor.ServiceIndex', verbose_name='\u5173\u8054\u670d\u52a1\u6307\u6807')),
                ('trigger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='foxmointor.Trigger', verbose_name='\u6240\u5c5e\u89e6\u53d1\u5668')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
        ...
        migrations.AddField(
            model_name='template',
            name='triggers',
            field=models.ManyToManyField(blank=True, to='foxmointor.Trigger', verbose_name='\u89e6\u53d1\u5668\u5217\u8868'),
        ),
        migrations.AddField(
            model_name='service',
            name='items',
            field=models.ManyToManyField(blank=True, to='foxmointor.ServiceIndex', verbose_name='\u6307\u6807\u5217\u8868'),
        ),
        migrations.AddField(
            model_name='hostgroup',
            name='templates',
            field=models.ManyToManyField(blank=True, to='foxmointor.Template'),
        ),
        migrations.AddField(
            model_name='host',
            name='host_groups',
            field=models.ManyToManyField(blank=True, to='foxmointor.HostGroup'),
        ),
        migrations.AddField(
            model_name='host',
            name='templates',
        ...
        migrations.AddField(
            ...
            name='notifiers',
            field=models.ManyToManyField(blank=True, to='foxmointor.UserProfile', verbose_name='\u901a\u77e5\u5bf9\u8c61'),
        ),
        migrations.AddField(
            model_name='action',
            name='host_groups',
        ...
        migrations.AddField(
            model_name='action',
            name='hosts',
            field=models.ManyToManyField(blank=True, to='foxmointor.Host'),
        ),
        migrations.AddField(
            model_name='action',
            name='operations',
            field=models.ManyToManyField(to='foxmointor.ActionOperation'),
        ),
        migrations.AddField(
            model_name='action',
            name='triggers',
            field=models.ManyToManyField(blank=True, help_text='\u60f3\u8ba9\u54ea\u4e9btrigger\u89e6\u53d1\u5f53\u524d\u62a5\u8b66\u52a8\u4f5c', to='foxmointor.Trigger'),
        ),
    ]
